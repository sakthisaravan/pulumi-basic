 ...
 */
export declare class DataType extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DataType;
    /**
     * Returns true if the given object is an instance of DataType.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DataType;
    /**
     * Field for database cache retention in days.
     */
    readonly databaseCacheRetention: pulumi.Output<number | undefined>;
    /**
     * Field for database data retention in days.
     */
    readonly databaseRetention: pulumi.Output<number | undefined>;
    /**
     ...
     */
    readonly storageOutputRetention: pulumi.Output<number | undefined>;
    /**
     ...
     */
    readonly visualizationUrl: pulumi.Output<string>;
    /**
